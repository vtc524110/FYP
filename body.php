    ...
    <div id="content">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo "<i id='session_username'>" . $_SESSION["username"] . "</i>" ?></span>
              <img class="img-profile rounded-circle" src="https://store.playstation.com/store/api/chihiro/00_09_000/container/AU/en/999/EP9000-BCES10370_00-AVACIPOCKETSTHEC/1520488094000/image?w=240&h=240&bg_color=000000&opacity=100&_version=00_09_000">
            </a>
      ...
      <div class="modal fade" id="profileModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel" data-target="#logoutModal">Profile</h5>
              <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
              </button>
            </div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $_SESSION["authority"]; ?></td>
                  </tr>
                </tbody>
              </table>
